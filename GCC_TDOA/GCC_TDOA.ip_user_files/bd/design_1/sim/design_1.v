...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=8,da_board_cnt=2,da_bram_cntlr_cnt=1,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (BRAM_PORTB_addr,
    BRAM_PORTB_clk,
    BRAM_PORTB_din,
    ...
    ram_rd_IRQ,
    rstn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTB ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTB, MASTER_TYPE BRAM_CTRL, MEM_ECC NONE, MEM_SIZE 8192, MEM_WIDTH 32, READ_LATENCY 1" *) input [31:0]BRAM_PORTB_addr;
  ...
  output [3:0]LED_A;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_240M CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_240M, ASSOCIATED_RESET RSTN, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 2.4e+08, INSERT_VIP 0, PHASE 0.000" *) output clk_240M;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.RAM_RD_IRQ INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.RAM_RD_IRQ, PortWidth 1, SENSITIVITY EDGE_RISING" *) input ram_rd_IRQ;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.RSTN RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RSTN, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) output [0:0]rstn;
  ...
  assign LED_A[3:0] = axi_gpio_0_gpio_io_o;
  assign clk_240M = processing_system7_0_FCLK_CLK0;
  assign rd_irq_1 = ram_rd_IRQ;
  assign rstn[0] = rst_ps7_0_240M_peripheral_aresetn;
  ...
  design_1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
       (.bram_addr_a(axi_bram_ctrl_0_BRAM_PORTA_ADDR),
        ...
        .s_axi_aresetn(rst_ps7_0_240M_peripheral_aresetn),
  ...
  design_1_axi_smc_1 axi_smc
       (.M00_AXI_araddr(axi_smc_M00_AXI_ARADDR),
        ...
        .aresetn(rst_ps7_0_240M_peripheral_aresetn));
  ...
  design_1_rst_ps7_0_240M_1 rst_ps7_0_240M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
