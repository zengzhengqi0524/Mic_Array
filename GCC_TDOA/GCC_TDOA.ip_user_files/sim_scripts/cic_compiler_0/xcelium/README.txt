...
#
# Generated by export_simulation on Wed May 19 20:20:28 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './cic_compiler_0.sh' script.

./cic_compiler_0.sh -reset_run
...
./cic_compiler_0.sh -noclean_files

For more information on the script, please type './cic_compiler_0.sh -help'.
